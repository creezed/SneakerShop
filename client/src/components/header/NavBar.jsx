...
const IconTextWrapper = styled.label`
  display: flex;
  align-items: center;
  gap: 16px;
  :hover {
    & > * {
      ${({ theme }) => theme.getTransition(.1,['color'], 'ease-out')};
    }
    & > span {
...
const NavBar = ({ hidden, setHidden }) => {
    ...
    return (
        <HeaderWrapper hidden={hidden}>
            <Close onClick={() => setHidden(!hidden)} viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <Navigate>
                <NavigateItem to={'/'}>Мужчины</NavigateItem>
                <NavigateItem to={'/'}>Женщины</NavigateItem>
                <NavigateItem to={'/'}>Дети</NavigateItem>
                <NavigateItem to={'/'}>Скидки</NavigateItem>
            </Navigate>
            <IconWrapper>
                <IconTextWrapper>
                    ...
                    <Text as='span' typography='m'>Профиль</Text>
                </IconTextWrapper>
                <IconTextWrapper>
                    ...
                    <Text as='span' typography='m'>Избранное</Text>
                </IconTextWrapper>
                <IconTextWrapper>
                    ...
                    <Text as='span' typography='m'>Корзина</Text>
                </IconTextWrapper>
                </IconWrapper>
        </HeaderWrapper>
    );
